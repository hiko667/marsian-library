...
namespace marsian_library.Controllers
{
    public class BookController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Isbn,PublisherId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Isbn,PublisherId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();

...
8. - [x] Wdrożenie aplikacji na produkcji (max 5pkt) – **Azre?**
9. - [x] Zastosowanie zewnętrznego API np. pobranie prognozy pogody,  zastosowanie OpenAI, płatności itp. (max. 5 pkt) – **płatności za opóźnione książki**
...
1. - [x] Aplikacja posiada obsługę formularzy do wyświetlania, usuwania, dodawania i edycji elementów – **zarządzanie książkami**
2. - [x] Aplikacja posiada moduł logowania, obsługuję autoryzację użytkownika – **biblitekarze, czytelnicy**
3. - [x] Aplikacja odwołuje się do Api zewnętrznego (pogoda, kursy, akcje, autoryzacja google/fb) – **płatności** 
4. - [x] Aplikacja udostępnia interfejs API – **dostępnych ebooków w bibliotece?**
5. - [x] Aplikacja posiada bazę danych oraz przechowuje trwale informacje – książki
6. - [x] Liczność encji niesłownikowych przekracza 7/osoba w grupie - minimalna ilość encji ogółem wynosi 10/osoba – książki
7. - [x] Aplikacja jest przejrzysta i estetyczna (zastosowanie zmian w stylowaniu)
